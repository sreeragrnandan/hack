  ...
  <section id="get-started" class="padd-section text-center wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        ...
        <p class="separator">A way to make com do what we need</p>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            ...
            <h4>introducing HTML</h4>
            <p>Hypertext Markup Language (HTML) is the standard markup language for creating web pages and web application...</p>
            <a href="#">read more</a>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            ...
            <h4>JAVA</h4>
            <p>Java is a general-purpose computer-programming language that is concurrent, class-based, object-oriented,and specifically</p>
            <a href="#">read more</a>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="feature-block">
              ...
              <h4>PHP</h4>
              <p> PHP: Hypertext Preprocessor (or simply PHP) is a server-side scripting language designed for web development. It was ori..</p>
              <a href="#">read more</a>
